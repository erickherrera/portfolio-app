...
// We don't need to import useTheme since ThemeToggle handles theme functionality
// import { useTheme } from "../components/ThemeContext";

export default function Home() {
  // No need to call useTheme() since we're not using any theme values directly
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section 
        id="home" 
        className="py-16 md:py-24 bg-gradient-to-b from-blue-50 to-white dark:from-gray-800 dark:to-gray-900 transition-colors duration-200"
      >
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <div className="flex flex-col items-center text-center">
            <h1 className="mb-4 mt-10 text-4xl sm:text-5xl font-extrabold text-gray-800 dark:text-white tracking-tight">
              Welcome to my portfolio.
            </h1>
            <h2 className="mb-6 text-lg sm:text-xl font-semibold text-gray-700 dark:text-gray-300">
            ...
            <div className="flex space-x-6 mt-4">
              <a 
                ...
                className="px-4 py-2 bg-blue-600 text-white font-bold rounded-md hover:bg-blue-700 transition-colors shadow-md dark:bg-blue-700 dark:hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-900"
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="px-4 py-2 bg-gray-800 text-white font-bold rounded-md hover:bg-gray-900 transition-colors shadow-md dark:bg-gray-700 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 dark:focus:ring-offset-gray-900"
      ...
      <section 
        id="about" 
        className="py-20 bg-white dark:bg-gray-800 border-t-4 border-blue-600 dark:border-blue-400 transition-colors duration-200"
      >
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <div className="flex flex-col md:flex-row items-center gap-8 md:gap-10">
            ...
            <div className="w-48 h-48 md:w-56 md:h-56 rounded-full overflow-hidden bg-gray-200 dark:bg-gray-700 flex-shrink-0 shadow-lg border-4 border-blue-600 dark:border-blue-400 transition-colors duration-200">
              <Image
                src="/me.jpg"
                alt="Profile photo"
                width={224}
      ...
      <footer className="bg-gray-800 dark:bg-gray-900 text-white py-6 mt-auto border-t-4 border-blue-600 dark:border-blue-400 transition-colors duration-200">
